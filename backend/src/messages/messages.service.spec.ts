...
describe('Messages service', () => {
    ...
    it('should return the list of message by topic id', () => {
        ...
        expect(service.findAllByTopic('ERERER'))
            .toEqual([{
                id: 'SCQDSQ',
                message: 'ZVCER',
                topicId: 'ERERER',
    ...
    describe('message creation', () => {
        it('should reject invalid messages', () => {
            ...
            expect(() => service.create({ topicId: 'whatever', message: 'Bonjour', creator: 'Test' })).toThrowError('Message is invalid');
        });
        ...
        it('should reject when trying to add a message to an unknown topic', () => {
            ...
            expect(() => service.create({ topicId: 'whatever', message: 'Bonjour, ça va', creator: 'Test' })).toThrowError('Topic does not exist');
        });

        it('should persist valid messages', () => {
            const service = module.get(MessagesService);

            const result = service.create({ topicId: 'ERERER', message: 'Bonjour, comment ça va bien', creator: 'Test' });
